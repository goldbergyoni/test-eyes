...
var require_util = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/util.js"(exports) {
    "use strict";
...
var require_validator = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/validator.js"(exports) {
    "use strict";
...
var require_OptionsBuilder = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/xmlparser/OptionsBuilder.js"(exports) {
    var defaultOptions = {
      preserveOrder: false,
...
var require_xmlNode = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/xmlparser/xmlNode.js"(exports, module) {
    "use strict";
    var XmlNode = class {
      constructor(tagname) {
...
var require_DocTypeReader = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/xmlparser/DocTypeReader.js"(exports, module) {
    var util = require_util();
...
var require_ignoreAttributes = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/ignoreAttributes.js"(exports, module) {
...
var require_OrderedObjParser = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/xmlparser/OrderedObjParser.js"(exports, module) {
    "use strict";
    var util = require_util();
...
var require_node2json = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/xmlparser/node2json.js"(exports) {
    "use strict";
...
var require_XMLParser = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/xmlparser/XMLParser.js"(exports, module) {
...
var require_orderedJs2Xml = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/xmlbuilder/orderedJs2Xml.js"(exports, module) {
    var EOL = "\n";
...
var require_json2xml = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/xmlbuilder/json2xml.js"(exports, module) {
    "use strict";
...
var require_fxp = __commonJS({
  "node_modules/.pnpm/fast-xml-parser@4.5.3/node_modules/fast-xml-parser/src/fxp.js"(exports, module) {
    "use strict";
    var validator = require_validator();
...
// apps/test-processing/scripts/action-collect.ts
import { parseArgs } from "util";

// apps/test-processing/src/junit-parser.ts
...
function buildRunData(tests, options = {}) {
...
async function parseAndBuildRunData(junitPath, options = {}) {
  const tests = await parseJUnitFile(junitPath);
  return buildRunData(tests, options);
}

// apps/test-processing/src/aggregate.ts
import path2 from "path";

// apps/test-processing/src/file-operations.ts
import { readFile as readFile2, writeFile, readdir, mkdir, cp, rm } from "fs/promises";
...
function generateTestDataFilename(commitSha) {
  const date = (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
  const shortSha = commitSha.slice(0, 7);
  return `${date}_${shortSha}.json`;
}
async function saveTestData(dataDir, filename, data) {
...
async function loadAggregatedData(filepath) {
...
async function saveAggregatedData(filepath, data) {
  const dir = path.dirname(filepath);
  await ensureDir(dir);
  await writeFile(filepath, JSON.stringify(data, null, 2));
}
async function findJsonFiles(dataDir, exclude = []) {
  ...
  return files.filter(
    (f) => f.endsWith(".json") && !excludeSet.has(f)
  );
}
async function findUnprocessedFiles(dataDir, processedFiles) {
  const allFiles = await findJsonFiles(dataDir, ["main-test-data.json", "index.json"]);
  return allFiles.filter((f) => !processedFiles.has(f));
}
...
function isValidRunData(data) {
  ...
  return obj.tests.every(
    (t) => typeof t === "object" && t !== null && typeof t.name === "string" && typeof t.durationMs === "number" && ["passed", "failed", "skipped"].includes(t.status)
  );
}
...
async function aggregate(dataDir) {
  const outputFile = path2.join(dataDir, "main-test-data.json");
...
// apps/test-processing/src/git-operations.ts
...
function getDefaultGitConfig() {
  return {
    userName: "github-actions[bot]",
    userEmail: "github-actions[bot]@users.noreply.github.com"
  };
}
async function fetchBranches(branches) {
...
// apps/test-processing/src/deploy.ts
import path3 from "path";

// apps/test-processing/src/collector.ts
async function collectTestData(options) {
  const {
    junitPath,
    outputPath,
    dataBranch,
...
async function main() {
  ...
  console.log("\u{1F4CA} Test Eyes - Collecting test data...");
